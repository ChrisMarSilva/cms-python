    ...
    class GamePage(Frame):
        def __init__(self, parent, controller):
            ...
            card_d1 = ImageTk.PhotoImage(
                Image.open("cards\default0.png").resize((55, 85), Image.Resampling.LANCZOS)) # Image.ANTIALIAS
            ...
            card_d2 = ImageTk.PhotoImage(
                Image.open("cards\default1.png").resize((55, 85), Image.Resampling.LANCZOS)) # Image.ANTIALIAS
...
# python -m pip install --upgrade Image
