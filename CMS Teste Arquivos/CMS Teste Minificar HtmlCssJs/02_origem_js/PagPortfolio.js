...
function fAlterarConfig() {
	try {

		 promise = new Promise((resolve, reject) => {

            let logNome = '@TamoNaBolsa - PagPortfolioAlterarConfig'
            console.time(logNome + ' - TEMPO')

            var NovoValor = $('#DivPortTotInvest').is(':visible') ? 'OFF' : 'ON';
            console.log( 'NovoValor', NovoValor, 'visible: ', $('#DivPortTotInvest').is(':visible'), 'hidden: ', $('#DivPortTotInvest').is(':hidden') );
...
async function fLimparPagina( urlPadrao ){        
    ...
    promise = new Promise( (resolve, reject) => {
        ...
        let logNome = '@TamoNaBolsa - PagPortfolioLimparPagina'
        console.time(logNome + ' - TEMPO')
...
async function fMontarTotalizadores( urlPadrao, TotInvest, TotAtual, TotValorizacao, PercValorizacao, TotRend, TotAlug, TotGanhoPerda, PercGanhoPerda ){  
    try {   
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarTotalizadores'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGridPercentualAtivos( urlPadrao, arCodAtivos, arValInvest, arValAtual ) {
    try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGridPercentualAtivos'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoCarteiraGeral( urlPadrao, TotInvest, TotAtual, TotRend, TotAlug ){ 
  try {   
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoCarteiraGeral'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoCarteiraAtivos( urlPadrao, arCodAtivos, arValInvest, arValAtual, arValValoriz, arValRenb ){
  try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoCarteiraAtivos'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoTotalValorizacao( urlPadrao, arCodAtivos, arValValoriz ){
  try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoTotalValorizacao'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoPercentualValorizacao( urlPadrao, arCodAtivos, arPercValoriz ){
  try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoPercentualValorizacao'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoTotalProventos( urlPadrao, arCodAtivos, arValRenb ){
  try {    
            ...
            promise = new Promise( (resolve, reject) => {
                ...
                let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoTotalProventos'
                console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoPesoAtivos( urlPadrao, arCodAtivos, arValAtual ) {
    try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoPesoAtivos'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoPesoSetores( urlPadrao, arSetorNome, arSetorTotal ) { 
      try {    
            ...
            promise = new Promise( (resolve, reject) => {
                ...
                let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoPesoSetores'
                console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoPesoSubSetores( urlPadrao, arSubSetorNome, arSubSetorTotal ) { 
    try {    
          ...
          promise = new Promise( (resolve, reject) => {
                ...
                let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoPesoSubSetores'
                console.time(logNome + ' - TEMPO')
...
async function fMontarGraficoPesoSegmentos( urlPadrao, arSegmentoNome, arSegmentoTotal ) { 
    try {    
            ...
            promise = new Promise( (resolve, reject) => {
                ...
                let logNome = '@TamoNaBolsa - PagPortfolioMontarGraficoPesoSegmentos'
                console.time(logNome + ' - TEMPO')
...
async function fMontarGridSetores( urlPadrao, TotAtual, arSetorQtde, arSetorTotal, arSubSetorQtde, arSubSetorTotal, arSegmentoQtde, arSegmentoTotal ) {
    try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGridSetores'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGridValorizacaoDia( urlPadrao, lista ) {
  try {    
        ...
        let logNome = '@TamoNaBolsa - PagPortfolioMontarGridValorizacaoDia'
        console.time(logNome + ' - TEMPO')
        ...
        DivListValDia.html(      "" );
         ...
         if ( lista.length > 0 ){
               ...
               lista.sort(function(a, b){
                  ...
                  var ValValorizA  = parseFloat( GetValorDecimalMaior( a.VlrValorizDia ) );
                  var PercValorizA = parseFloat( GetValorDecimal( a.PercValorizDia ) );

                  var ValValorizB  = parseFloat( GetValorDecimalMaior( b.VlrValorizDia ) );
               ...
               $.each(lista, function (index, value) {
                    ...
                    if ( TipoInvest == 'CRIPTO' ) {
                        ...
                        var ValAtual    = parseFloat( GetValorDecimalMaior( value.PrecoAtual ) );
                        var ValValoriz  = parseFloat( GetValorDecimalMaior( value.VlrValorizDia ) );
...
async function fMontarGridIndices( urlPadrao ) {
    try {    
          ...
          promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGridIndices'
            console.time(logNome + ' - TEMPO')
...
async function fMontarGridRadar( urlPadrao ) {
    try {    
            ...
            promise = new Promise( (resolve, reject) => {
               ...
               let logNome = '@TamoNaBolsa - PagPortfolioMontarGridRadar'
               console.time(logNome + ' - TEMPO')
...
async function fMontarGridCarteira( urlPadrao, dataSet, IdPortfolio, TipoInvest ) {
 try {    
        ...
        promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioMontarGridCarteira'
            console.time(logNome + ' - TEMPO')
...
async function fMontarPagina( urlPadrao ){
     ...
     promise = new Promise( (resolve, reject) => {
		...
		let logNome = '@TamoNaBolsa - PagPortfolioMontarPagina'
		console.time(logNome + ' - TEMPO')
                 ...
                 success: function(result) {
                    ...
                    if (resultado == "NSESSAO") {
                        ...
                        DataSetPagina = result;
                         ...
                         setTimeout(() => { fMontarGridValorizacaoDia( urlPadrao, arProftfolio ); }, 1);
                         setTimeout(() => { fMontarGridPercentualAtivos( urlPadrao, arCodAtivos, arValInvest, arValAtual ); }, 1);

                         setTimeout(() => { fMontarGraficoCarteiraAtivos( urlPadrao, arCodAtivos, arValInvest, arValAtual, arValValoriz, arValRenb ); }, 1);
                         setTimeout(() => { fMontarGridCarteira( urlPadrao, arDataSet, IdPortfolio, TipoInvest ); }, 1);
                         setTimeout(() => { fMontarGraficoTotalValorizacao( urlPadrao, arCodAtivos, arValValoriz ); }, 1);
                         setTimeout(() => { fMontarGraficoPercentualValorizacao( urlPadrao, arCodAtivos, arPercValoriz ); }, 1);
                         setTimeout(() => { fMontarGraficoTotalProventos( urlPadrao, arCodAtivos, arValRenb ); }, 1);

                         setTimeout(() => { fMontarGraficoPesoAtivos( urlPadrao, arCodAtivos, arValAtual ); }, 1);
                         setTimeout(() => { fMontarGraficoPesoSetores( urlPadrao, arSetorNome, arSetorTotal ); }, 1);
                         setTimeout(() => { fMontarGraficoPesoSubSetores( urlPadrao, arSubSetorNome, arSubSetorTotal ); }, 1);
                         setTimeout(() => { fMontarGraficoPesoSegmentos( urlPadrao, arSegmentoNome, arSegmentoTotal ); }, 1);

                         //console.log('Total: ' + TotAtualAtivos);
                         setTimeout(() => { fMontarGridSetores( urlPadrao, TotAtualAtivos, arSetorQtde, arSetorTotal, arSubSetorQtde, arSubSetorTotal, arSegmentoQtde, arSegmentoTotal ); }, 1);
...
async function fCarregarPaginaIndiceRadar( urlPadrao ){
    try {
        ...
        promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioIndiceRadar'
            console.time(logNome + ' - TEMPO')
...
async function fRecarregarPagina( urlPadrao, Id ){
    try {   
        ...
        promise = new Promise( (resolve, reject) => {
            ...
            let logNome = '@TamoNaBolsa - PagPortfolioRecarregar'
            console.time(logNome + ' - TEMPO')
